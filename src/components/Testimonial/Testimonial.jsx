...
const TestimonialData = [
  {
    ...
    img: "https://img.freepik.com/premium-photo/close-up-female-portrait-beautiful-young-asian-woman-formal-suit-korean-businesswoman-chinese_717737-3463.jpg",
  ...
  },
  {
    ...
    name: "Mansi",
    designation: "Developer",
    img: "https://www.shutterstock.com/image-photo/woman-serious-closeup-portrait-business-260nw-713818378.jpg",
    text: "lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
    delay: 0.4,
  },
  {
    ...
    name: "Shaheera",
    designation: "Developer",
    img: "https://img.freepik.com/premium-photo/close-up-woman-suit-with-office_1124848-132382.jpg",
    text: "lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
    delay: 0.6,
  },
];
  ...
  return (
    <div className="py-14">
      ...
      <div className="space-y-4 text-center max-w-[550px] mx-auto mb-8">
        ...
        >
          Empowering students for a successful career launch
        </motion.p>
      </div>
      {/* tesitomonial cards */}
